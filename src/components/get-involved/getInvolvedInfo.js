        ...
        <div className={getInvolvedInfoStyles.container}>
            ...
            <div>
                <div className={getInvolvedInfoStyles.infoContainer}>
                    <div>
                        <p>
                            Get involved with a KCSOC near you. We are always
                            open to all university members and we want to share
                            our love of spirituality, meditation and philosophy
                            as far and wide as we can.
                        </p>
                        <p>
                            Currently, due to the new lockdown rules imposed by
                            the UK government, we are not able to hold our
                            sessions in person. Rather, we have moved our talks,
                            workshops and retreats online, so you can enjoy our
