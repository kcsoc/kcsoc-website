...
import aboutUSStyles from "../styles/components/aboutUS.module.scss"
    ...
    return (
        <FadeIn>
            ...
            <div className={aboutUSStyles.header}>
                ...
                <h2 className={aboutUSStyles.head2}>Fuelled by Knowledge and Devotion</h2>
            ...
            <Fade>
                <h1 className={aboutUSStyles.philosophy}>Philosophy</h1>
            ...
            <div className={aboutUSStyles.ac}>
                <div>
                    <h1 className={aboutUSStyles.h4}>Inspiration</h1>
                    <h2 className={aboutUSStyles.h4}>A.C. Bhaktivedanta Swami Prabhupada</h2>
                    <Fade>
                        <img 
